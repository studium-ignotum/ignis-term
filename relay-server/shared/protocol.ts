...
// =============================================================================
// Relay -> Mac Client Messages (notifications)
// =============================================================================

/**
 * Relay notifies Mac that a browser has connected/reconnected.
 * Mac should resend initial state (sessions, config, screen content).
 */
export const BrowserConnectedMessage = z.object({
  type: z.literal('browser_connected'),
  sessionId: z.string().uuid(),
});
export type BrowserConnectedMessage = z.infer<typeof BrowserConnectedMessage>;
...
/**
 * Request screen content refresh from Browser to Mac (reconnect/refresh scenario)
 */
export const ScreenRefreshRequestMessage = z.object({
  type: z.literal('request_screen_refresh'),
  sessionId: z.string().optional(), // If omitted, refresh active session
});
export type ScreenRefreshRequestMessage = z.infer<typeof ScreenRefreshRequestMessage>;
